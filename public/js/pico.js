...
pico.unpackCascade = function(bytes)
{
	//
...
pico.runCascade = function(image, classifyRegion, params)
{
...
pico.clusterDetections = function(dets, iouthreshold)
{
	/*
...
pico.instantiateDetectionMemory = function(size)
{
	/*
